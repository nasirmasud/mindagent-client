  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-slate-50 to-white dark:from-[#0A0820] dark:to-[#0B0B1F] py-16 md:py-24">
      <div className="mx-auto w-full px-4 md:px-20">
        <div className="relative rounded-lg border border-slate-200/60 dark:border-[#2E274A]/60 bg-white/70 dark:bg-[#1E1A35]/70 backdrop-blur-xl shadow-xl shadow-indigo-500/5 dark:shadow-indigo-500/10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-200/50 dark:divide-[#2E274A]/50">
            {features.map(({ icon: Icon, title, description }) => (
              ...
              >
                <span className="relative mb-5 flex h-14 w-14 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/40 dark:to-indigo-800/30 transition-all duration-500 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-indigo-500/20">
