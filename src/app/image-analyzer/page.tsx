      ...
      <section className="relative overflow-hidden border-b border-border pt-16 pb-14 md:pt-20 md:pb-16">
        ...
        <div className="relative z-10 mx-auto max-w-[1600px] px-4 text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Show it a picture.
            <br />
            <span className="bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">Get the whole story.</span>
          </h1>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[280px_1fr]">
          ...
          <aside className="order-2 lg:order-1">
            <div className="rounded-2xl border border-border bg-card p-4 lg:sticky lg:top-24">
              ...
              <div className="mb-3 hidden lg:flex items-center gap-1.5 rounded-lg border border-border bg-muted px-2.5 py-1.5">
                  ...
                  history.map((h) => (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="truncate text-[10px] text-muted-foreground">{h.prompt || "No prompt"} &middot; {timeAgo(h.createdAt)}</p>
                      </div>
                      <button
                ...
                >
                  ...
                  {!preview && (
                    <div className="flex flex-col items-center px-6 text-center">
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">JPG, PNG, or WEBP up to 15MB</p>
                    </div>
                  )}
                ...
                <div className="mt-5 flex-1 rounded-2xl border border-border bg-card p-5">
                  ...
                  {stage === "idle" && (
                    <div className="flex h-40 flex-col items-center justify-center text-center">
                      <Eye size={22} className="mb-2 text-muted-foreground" />
                      <p className="text-xs text-muted-foreground">Upload an image and hit analyze to see what the agent finds.</p>
                    </div>
                  )}
                  ...
                  {stage === "done" && analysis && (
                    <div className="pt-3">
                      <p className="text-sm leading-relaxed text-muted-foreground whitespace-pre-wrap">{analysis}</p>
