...
export default function LoginPage() {
  ...
  const [regErrors, setRegErrors] = useState({ name: false, email: false, password: false, confirm: false, terms: false });
  ...
  useEffect(() => {
    const tab = activeTab === "login" ? loginTabRef.current : registerTabRef.current;
    if (tab) {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    setRegErrors({ name: !nameValid, email: !emailValid, password: !passwordValid, confirm: !confirmValid, terms: !termsValid });
    ...
    try {
      ...
      const data: any = await api("/auth/register", {
        method: "POST",
        body: JSON.stringify({ name: regName.trim(), email: regEmail, password: regPassword, avatar: avatarUrl }),
      });
      login(data.token, data.user);
  ...
  const strengthLabels = ["Too weak", "Weak — add numbers or symbols", "Good password strength", "Strong password"];
      ...
      <div className="min-h-full w-full flex items-center justify-center px-4 py-4 bg-indigo-50 dark:bg-[#0A0820]">
        <div className="auth-card relative w-full max-w-4xl mx-auto bg-white dark:bg-[#1E1A35] rounded-3xl shadow-xl shadow-indigo-100 dark:shadow-indigo-900/20 overflow-hidden grid grid-cols-1 lg:grid-cols-2">
          ...
          <div
            ...
            style={{
              background: "radial-gradient(circle at 20% 15%, rgba(255,255,255,0.14), transparent 45%), linear-gradient(135deg, #4f3fd6 0%, #6c4ee6 55%, #8b5cf6 100%)",
            }}
          >
            ...
            {activeTab === "login" ? (
              <>
                <div className="relative">
                  <div className="flex items-center gap-2">
                    <img src="/favicon.ico" alt="MindAgent" className="w-8 h-8" />
                    <span className="font-bold text-lg">MindAgent</span>
                  </div>
                  <h1 className="mt-10 text-3xl font-bold leading-tight">
                    AI Agents That<br />Think. Create.<br />Deliver Results.
                  </h1>
                  <p className="mt-4 text-white/80 text-sm max-w-xs">
                    Sign in to access your AI agents, saved analyses, and personalized insights.
                  </p>
                </div>
                <div className="relative flex flex-col gap-2.5">
                  <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-300 hover:translate-x-1 hover:bg-white/10">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-white/90 flex-shrink-0"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>
                    <span className="text-sm text-white/90">Turn CSV, Excel & JSON into instant insights</span>
                  </div>
                  <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-300 hover:translate-x-1 hover:bg-white/10">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-white/90 flex-shrink-0"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                    <span className="text-sm text-white/90">Your data is encrypted and always private</span>
                  </div>
                  <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-300 hover:translate-x-1 hover:bg-white/10">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-white/90 flex-shrink-0"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    <span className="text-sm text-white/90">Trusted by 15,000+ users worldwide</span>
                  </div>
                </div>
              </>
            ) : (
              <>
                <div className="relative">
                  ...
                  <h1 className="mt-10 text-3xl font-bold leading-tight">
                    Join 15,000+<br />Teams Building<br />with AI Agents.
                  </h1>
                  <p className="mt-4 text-white/80 text-sm max-w-xs">
                    Create your free account and start turning data, docs, and ideas into results in seconds.
                  </p>
                </div>
                <div className="relative flex flex-col gap-2.5">
                  <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-300 hover:translate-x-1 hover:bg-white/10">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-white/90 flex-shrink-0"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg>
                    <span className="text-sm text-white/90">Free plan — no credit card required</span>
                  </div>
                  <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-300 hover:translate-x-1 hover:bg-white/10">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-white/90 flex-shrink-0"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>
                    <span className="text-sm text-white/90">Analyze CSV, Excel & JSON instantly</span>
                  </div>
                  <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-300 hover:translate-x-1 hover:bg-white/10">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-white/90 flex-shrink-0"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                    <span className="text-sm text-white/90">Your data is encrypted and always private</span>
          ...
          <div className="relative p-6 sm:p-8">
            ...
            <div className="flex lg:hidden items-center gap-2 mb-6">
              ...
              <span className="font-bold text-slate-900 dark:text-white">MindAgent</span>
            </div>
            ...
            <div className="grid grid-cols-1" style={{ minHeight: panelMinHeight || undefined }}>
              {/* LOGIN PANEL */}
              <div
              ...
              >
                  ...
                  <form onSubmit={handleLogin} noValidate>
                    ...
                    <div className="relative mb-1">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-slate-400 absolute left-3.5 top-1/2 -translate-y-1/2"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                      <input
                        type="email"
                        placeholder="you@example.com"
                        value={loginEmail}
                        onChange={(e) => { setLoginEmail(e.target.value); setLoginErrors(prev => ({ ...prev, email: false })); }}
                    ...
                    <p className={`field-error text-xs text-red-500 mb-3 ${loginErrors.email ? "show" : ""}`}>
                      Please enter a valid email address.
                    </p>

                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1.5">Password</label>
                    <div className="relative mb-1">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-slate-400 absolute left-3.5 top-1/2 -translate-y-1/2"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                      <input
                        type="password"
                        placeholder="••••••••"
                        value={loginPassword}
                        onChange={(e) => { setLoginPassword(e.target.value); setLoginErrors(prev => ({ ...prev, password: false })); }}
                    ...
                    <p className={`field-error text-xs text-red-500 mb-1 ${loginErrors.password ? "show" : ""}`}>
                    ...
                    <div className="flex items-center justify-between mt-3 mb-6">
                      ...
                      <a href="#" className="text-xs font-semibold text-indigo-600 hover:text-indigo-700 dark:hover:text-indigo-400">
                        Forgot password?
                      </a>
                    </div>
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><path d="M10 2v2"/><path d="M14 2v2"/><path d="M16 8a6 6 0 0 1 6 6v2"/><path d="M4 16a6 6 0 0 1 6-6h4a6 6 0 0 1 6 6v2"/><rect x="2" y="16" width="20" height="6" rx="2"/></svg>
                    Use Demo Account
                  </button>
                  ...
                  <p className="text-center text-xs text-slate-500 dark:text-slate-400 mt-6">
                    ...
                    <button onClick={() => setActiveTab("register")} className="font-semibold text-indigo-600 hover:text-indigo-700 dark:hover:text-indigo-400">
                      Sign up free
                    </button>
                  </p>
              </div>
              ...
              <div
                ...
                className={`col-start-1 row-start-1 transition-all duration-300 ${
                  activeTab === "register" ? "opacity-100" : "opacity-0 pointer-events-none"
                }`}
              >
                  <span className="inline-flex items-center gap-1.5 text-xs font-semibold tracking-wide text-indigo-600 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-800 px-3 py-1 rounded-full uppercase mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                    Get Started Free
                  </span>

                  <h2 className="text-xl font-bold text-slate-900 dark:text-white">Create your account</h2>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 mb-4">It takes less than a minute.</p>
                  ...
                  <form onSubmit={handleRegister} noValidate>
                      ...
                      >
                        {avatarPreview ? (
                          <>
                            ...
                            <button
                              type="button"
                              onClick={(e) => { e.stopPropagation(); setAvatarPreview(null); if (avatarInputRef.current) avatarInputRef.current.value = ""; }}
                            ...
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-2.5 h-2.5"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
                            </button>
                          </>
                        ) : (
                          <>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-slate-400"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                            <div className="absolute bottom-0 right-0 w-6 h-6 rounded-full bg-indigo-600 border-2 border-white dark:border-[#1E1A35] flex items-center justify-center">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-3 h-3 text-white"><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/><circle cx="12" cy="13" r="3"/></svg>
                            </div>
                          </>
                        )}
                      </div>
                      <p className="text-center text-xs text-slate-400 dark:text-slate-500 mt-1.5">Add a profile photo <span className="text-slate-300 dark:text-slate-600">(optional)</span></p>
                    </div>

                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-300 mb-1.5">Full name</label>
                    <div className="relative mb-1">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-slate-400 absolute left-3.5 top-1/2 -translate-y-1/2"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                      <input
                        type="text"
                        placeholder="Jane Doe"
                        value={regName}
                        onChange={(e) => { setRegName(e.target.value); setRegErrors(prev => ({ ...prev, name: false })); }}
                        className={`w-full h-11 pl-10 pr-3 rounded-xl border text-sm text-slate-800 dark:text-white outline-none transition-all duration-250 ${
                          regErrors.name
                            ? "border-red-500 shadow-[0_0_0_4px_rgba(239,68,68,0.10)]"
                            : "border-slate-200 dark:border-[#2E274A] bg-slate-50 dark:bg-[#16132B] focus:border-indigo-500 focus:shadow-[0_0_0_4px_rgba(108,78,230,0.12)] focus:bg-white dark:focus:bg-[#1E1A35]"
                    ...
                    <p className={`field-error text-xs text-red-500 mb-3 ${regErrors.name ? "show" : ""}`}>
                    ...
                    <p className={`field-error text-xs text-red-500 mb-3 ${regErrors.email ? "show" : ""}`}>
                      Please enter a valid email address.
                    </p>
                    ...
                    <div className="relative mb-1">
                      ...
                      <input
                        ...
                        value={regPassword}
                        onChange={(e) => { setRegPassword(e.target.value); setRegErrors(prev => ({ ...prev, password: false })); updateStrength(e.target.value); }}
                        className={`w-full h-11 pl-10 pr-10 rounded-xl border text-sm text-slate-800 dark:text-white outline-none transition-all duration-250 ${
                          regErrors.password
                            ? "border-red-500 shadow-[0_0_0_4px_rgba(239,68,68,0.10)]"
                            : "border-slate-200 dark:border-[#2E274A] bg-slate-50 dark:bg-[#16132B] focus:border-indigo-500 focus:shadow-[0_0_0_4px_rgba(108,78,230,0.12)] focus:bg-white dark:focus:bg-[#1E1A35]"
                    ...
                    <div className="flex gap-1.5 mt-2 mb-1">
                      {[0, 1, 2].map((i) => (
                        <div key={i} className="h-1 flex-1 rounded-full bg-slate-200 dark:bg-[#2E274A] overflow-hidden">
                          <div
                            className="h-full rounded-full transition-all duration-350"
                            style={{
                              width: regStrength > i ? "100%" : "0%",
                              backgroundColor: regStrength > 0 ? strengthColors[Math.min(regStrength - 1, 2)] : "#e2e8f0",
                            }}
                          />
                        </div>
                      ))}
                    ...
                    <p className={`field-error text-xs text-red-500 mb-3 ${regErrors.password ? "show" : ""}`}>
                      Password must be at least 6 characters.
                    </p>
                    ...
                    <div className="relative mb-1">
                      ...
                      <input
                        ...
                        value={regConfirm}
                        onChange={(e) => { setRegConfirm(e.target.value); setRegErrors(prev => ({ ...prev, confirm: false })); }}
                        className={`w-full h-11 pl-10 pr-10 rounded-xl border text-sm text-slate-800 dark:text-white outline-none transition-all duration-250 ${
                          regErrors.confirm
                            ? "border-red-500 shadow-[0_0_0_4px_rgba(239,68,68,0.10)]"
                            : "border-slate-200 dark:border-[#2E274A] bg-slate-50 dark:bg-[#16132B] focus:border-indigo-500 focus:shadow-[0_0_0_4px_rgba(108,78,230,0.12)] focus:bg-white dark:focus:bg-[#1E1A35]"
                    ...
                    <p className={`field-error text-xs text-red-500 mb-3 ${regErrors.confirm ? "show" : ""}`}>
                    ...
                    <label className="flex items-start gap-2 text-xs text-slate-500 dark:text-slate-400 mb-1 mt-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={regTerms}
                        onChange={(e) => { setRegTerms(e.target.checked); setRegErrors(prev => ({ ...prev, terms: false })); }}
                    ...
                    <p className={`field-error text-xs text-red-500 mb-3 ${regErrors.terms ? "show" : ""}`}>
                  ...
                  <p className="text-center text-xs text-slate-500 dark:text-slate-400 mt-4">
                    ...
                    <button onClick={() => setActiveTab("login")} className="font-semibold text-indigo-600 hover:text-indigo-700 dark:hover:text-indigo-400">
                      Log in
                    </button>
                  </p>
              </div>
